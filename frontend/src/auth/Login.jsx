    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-gray-50">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Sign in to your ArtiSpace account</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full py-3 pl-10 pr-12 transition-all border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                required
              />
              <button
                type="button"
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center px-4 py-2 transition-colors border border-gray-300 rounded-lg hover:bg-gray-50">
